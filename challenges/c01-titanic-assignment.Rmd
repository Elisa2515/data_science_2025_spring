...
The Wikipedia article says there were about 2,224 passengers, while our calculation showed 2,201. That’s a difference of 23 people.
Why is there a difference?
The number of passengers and deaths can vary between sources because some people traveled using fake names, and some records might be incomplete or inaccurate.
  - ...
...
**Observations**:
First class is the group with the most women except for the crew. While the third class is the only where the females and males who survived are evenly split.
