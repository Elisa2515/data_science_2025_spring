...
The mean velocity are the same for distinctness levels 3 and 2 but lower for distinctness level 1.
The number of measurements (n) decreases as the distinctness quality decreases
- Why might your table differ from Michelson's?
Michelson may have used a different method to calculate the mean velocity, which then gave him differnet results
